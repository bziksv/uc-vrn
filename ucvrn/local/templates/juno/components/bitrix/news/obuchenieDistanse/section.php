...
<div class="page_content">
    <div class="container">
        <div class="description_text no_margin_top">
            <div class="text_container">
                <?
                $APPLICATION->IncludeComponent("bitrix:main.include", "", ["AREA_FILE_SHOW" => "file",
                    "PATH" => SITE_DIR . "include/distantsionnoe-obuchenie/text1.php"], false);
                ?>
            </div>
        </div>
        <div class="text_container sub_title">
            <?
            $APPLICATION->IncludeComponent("bitrix:main.include", "", ["AREA_FILE_SHOW" => "file",
                "PATH" => SITE_DIR . "include/distantsionnoe-obuchenie/title1.php"], false);
            ?>
        </div>
        <div class="tab_container">
            <? $sectionList = getSectionList(9); ?>
            <? $GLOBALS['filterDistLearning'] = ['PROPERTY_PROP_ONLINE_VALUE' => 'да'] ?>
            <div class="tab_label_container">
                <a href="/distantsionnoe-obuchenie/" class="<?= $APPLICATION->GetCurPage() == '/distantsionnoe-obuchenie/' ? 'active' : '' ?>">Все</a>
                <? foreach ($sectionList as $key => $section) { ?>
                    <a 
                        href="/distantsionnoe-obuchenie/<?= $section['CODE'] ?>/" 
                        class="<?= $APPLICATION->GetCurPage() == "/distantsionnoe-obuchenie/{$section['CODE']}/" ? 'active' : '' ?>">
                            <?= $section['NAME'] ?>
                    </a>
                <? } ?>
                <div class="show_more_tabs"></div>
            </div>
                ...
                <div class="tab_value_item active">
                    ...
                    $APPLICATION->IncludeComponent(
                            ...
                            Array(
                                ...
                                "FILTER_NAME" => 'filterDistLearning',
