    ...
    <div class="container">
        <div class="question-form-wr question-form-wr_big">
            <div class="left_side">
                ...
                <div class="form_desc">
					<p><a href="upload/Forma_zayavki.docx">Скачать форму заявки на обучение</a></p>
            ...
            <div class="question-form_content-wr">
                <div class="question-form_content">
                    <form class="send_mail_raba">
                        <input type="hidden" name="formTitle" value="Заявка на обучение">
                        ...
                        <input type="checkbox" required id="agreement4" name="agreement" style="display: none">
