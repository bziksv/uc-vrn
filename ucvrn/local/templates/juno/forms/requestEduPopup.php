<div class="question-form form_popup" id="requestEduPopup" style="display: none">
    <div class="container">
        <div class="question-form-wr">
            <div class="left_side">
                <div class="form_title">Задайте нам вопрос</div>
            ...
            <div class="question-form_content-wr">
                <div class="question-form_content">
                    <form class="send_mail_raba">
                        ...
                        <input type="checkbox" required id="agreement3" name="agreement" style="display: none">
