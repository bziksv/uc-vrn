...
global $LANG_CUSTOM;
$this->createFrame()->begin($LANG_CUSTOM['Загрузка навигации']);
?>
<? if ($arResult["NavPageCount"] > 1) { ?>
    <? if ($arResult["NavPageNomer"] + 1 <= $arResult["nEndPage"]) { ?>
        ...
        ?>
        <div class="pagination_container news_more-load more-load-btn load_more ajax_load" data-url="<?= $url ?>" data-numPage="<?= $arResult["NavNum"] ?>">
